    ...
    <div class="app-container">
      ...
      <el-card shadow="never" class="basic-list-bar">
        <el-form ref="barSearch" label-position="left" :model="barSearch" label-width="80px">
          <el-form-item
            label="类型:"
            :class="['row', 'auto-hidden', { 'expand': barSearch.expandInputs }]"
          >
            <el-row>
              <el-col :span="2">
                <el-checkbox
                  ...
                  @change="handlecheckedTypesAllChange"
                >全选</el-checkbox>
              </el-col>
              <el-col :span="20">
                <el-checkbox-group
                  v-model="barSearch.checkedTypes"
                  @change="handleCheckedTypesChange"
                >
                  <el-checkbox
                    v-for="item in barSearch.typesList"
                    :label="item"
                    :key="item"
                  >{{item}}</el-checkbox>
                </el-checkbox-group>
